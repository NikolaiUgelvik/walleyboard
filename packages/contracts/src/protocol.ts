...
export const updateProjectInputSchema = z.object({
  ...
  worktree_init_command: z.string().min(1).nullable().optional(),
  worktree_teardown_command: z.string().min(1).nullable().optional(),
  worktree_init_run_sequential: z.boolean().optional(),
