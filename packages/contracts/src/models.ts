...
export const projectSchema = z.object({
  ...
  worktree_init_command: z.string().min(1).nullable(),
  worktree_teardown_command: z.string().min(1).nullable(),
  worktree_init_run_sequential: z.boolean(),
...
export const executionAttemptSchema = z.object({
  ...
  prompt_kind: z.enum(["plan", "implementation", "merge_conflict"]).nullable(),
